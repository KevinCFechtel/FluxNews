...
Future<void> main() async {
  ...
  WidgetsBinding.instance.addPostFrameCallback((_) async {
    try {
      ...
      final clearValue = await storage.read(
  ...
  Widget getMaterialApp(BuildContext context) {
    ...
    return DynamicColorBuilder(
      ...
      return MaterialApp(
        ...
        themeMode: themeState.brightnessMode ==
        ...
        routes: {
          ...
          FluxNewsState.feedOnboardingRouteString: (context) =>
              const FeedOnboarding(),
          FluxNewsState.restoreSettingsRouteString: (context) =>
              const RestoreSettingsPage(),
          FluxNewsState.settingsRouteString: (context) => const Settings(),
          FluxNewsState.searchRouteString: (context) => const Search(),
          FluxNewsState.feedSettingsRouteString: (context) =>
              const FeedSettings(),
          FluxNewsState.generalSettingsRouteString: (context) =>
              const GeneralSettings(),
          FluxNewsState.syncSettingsRouteString: (context) =>
              const SyncSettings(),
          FluxNewsState.newsItemSettingsRouteString: (context) =>
              const NewsItemSettings(),
          FluxNewsState.truncateSettingsRouteString: (context) =>
              const TruncateSettings(),
          FluxNewsState.headerSettingsRouteString: (context) =>
              const HeaderSettings(),
          FluxNewsState.widgetSettingsRouteString: (context) =>
