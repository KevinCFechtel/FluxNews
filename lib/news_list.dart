...
Widget landscapeNewsListWidget(BuildContext context, FluxNewsState appState) {
...
Widget portraitNewsListWidget(BuildContext context, FluxNewsState appState) {
  var getData = FutureBuilder<List<News>>(
    future: appState.newsList,
    builder: (context, snapshot) {
      switch (snapshot.connectionState) {
                    ...
                    : Stack(children: [
                        NotificationListener<ScrollEndNotification>(
                          child: ScrollablePositionedList.builder(
                              ...
                              initialScrollIndex: appState.scrollPosition,
                              itemBuilder: (context, i) {
                                return showNewsCard(snapshot.data![i], appState,
                                    context, false);
                              }),
                          // on ScrollNotification set news as read on scrollover if activated
                          onNotification: (ScrollNotification scrollInfo) {
